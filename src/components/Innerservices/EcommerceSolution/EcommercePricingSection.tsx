...
const PLANS: Plan[] = [
    {
        name: "Starter Store",
        description: "Perfect For Launching Your First Online Store With Core Essentials",
        price: "$499.00",
        features: [
            "Up To 25 Products",
    ...
    {
        name: "Growth Store",
        description: "For Stores Ready To Scale Their Catalog And Customer Base",
        price: "$899.00",
        features: [
            "Up To 100 Products",
    ...
    },
    {
        ...
        description: "Full-Scale E-commerce With Advanced Integrations And Support",
        price: "$2,499.00",
        features: [
            "Unlimited Products",
    ...
    return (
        <section className="relative w-full bg-[#f5f5f4] px-6 py-20 font-atyp md:px-12 lg:py-28">
            ...
            >
                ...
                >
                    Store Plans For <span className="font-semibold text-brand">EVERY STAGE</span>
                </motion.h2>
                ...
                >
                    Whether You're Launching Your First Store Or Scaling A Growing Catalog,
                    We Have A Plan Built To Match Where You Are.
                </motion.p>
            </motion.div>

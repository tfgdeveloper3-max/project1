...
const PLANS: Plan[] = [
    {
        ...
        description: "A Small Batch Of Content To Get Your Pages And Blog Moving",
        price: "$199.00",
        features: [
            "Up To 5 Pages Or Articles",
            "1 Revision Round",
            "Basic SEO Keyword Inclusion",
        ],
    },
    {
        name: "Growth Content",
        description: "Ongoing Content Built To Grow Traffic And Engagement",
        price: "$449.00",
        features: [
            "Up To 15 Pages Or Articles",
            "3 Revision Rounds",
    ...
    {
        name: "Content Engine",
        description: "A Full Content Pipeline For Brands Publishing Consistently",
        price: "$899.00",
        features: [
            "Unlimited Monthly Content",
            "Dedicated Content Strategist",
            "Editorial Calendar Included",
        ],
    },
];
...
function PenIcon({ className }: { className?: string }) {
    return (
        <svg viewBox="0 0 24 24" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
                d="M4 20l3.5-1 10-10a1.8 1.8 0 0 0 0-2.5l-.9-.9a1.8 1.8 0 0 0-2.5 0l-10 10L3 19.5V20h1Z"
                stroke="currentColor"
                strokeWidth="1.5"
                strokeLinejoin="round"
            />
            <path d="M13.5 6.5l3 3" stroke="currentColor" strokeWidth="1.3" />
        </svg>
    );
}
...
export default function ContentWritingPricingSection() {
    ...
    return (
        <section className="relative w-full bg-[#f5f5f4] px-6 py-20 font-atyp md:px-12 lg:py-28">
            ...
            >
                ...
                >
                    Content Plans For <span className="font-semibold text-brand">EVERY NEED</span>
                </motion.h2>
                ...
                >
                    From A Handful Of Pages To A Full Monthly Content Pipeline, We Have
                    A Writing Plan Built To Match Your Publishing Pace.
                </motion.p>
            </motion.div>

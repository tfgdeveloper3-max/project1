...
const PLANS: Plan[] = [
    {
        name: "Brand Starter",
        description: "Essential Branding Basics To Get A New Business Off The Ground",
        price: "$299.00",
        features: [
            "Logo Design",
            "Core Color Palette",
    ...
    {
        name: "Brand Identity",
        description: "A Complete, Cohesive Identity System Ready For Every Channel",
        price: "$699.00",
        features: [
            "Full Logo Suite",
    ...
    {
        name: "Brand Complete",
        description: "End-To-End Branding For Established Companies Going All In",
        price: "$1,499.00",
        features: [
...
function PaletteIcon({ className }: { className?: string }) {
    return (
        <svg viewBox="0 0 24 24" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
                d="M12 3.5A8.5 8.5 0 1 0 12 20.5c1 0 1.6-.7 1.6-1.5 0-.4-.2-.7-.4-1-.2-.3-.4-.6-.4-1 0-.8.6-1.5 1.5-1.5H16a4.5 4.5 0 0 0 4.5-4.5c0-4.4-3.8-7.5-8.5-7.5Z"
                stroke="currentColor"
                strokeWidth="1.5"
    ...
    return (
        <section className="relative w-full bg-[#f5f5f4] px-6 py-20 font-atyp md:px-12 lg:py-28">
            ...
            >
                ...
                >
                    Brand Plans For <span className="font-semibold text-brand">EVERY STAGE</span>
                </motion.h2>
                ...
                >
                    From A Simple Logo To A Complete Identity System, We Have A Branding
                    Plan Built To Match Where Your Business Is Headed.
                </motion.p>
            </motion.div>

...
const PLANS: Plan[] = [
    {
        name: "Basic Logo",
        description: "A Simple, Clean Logo Design To Get Your Brand Started",
        price: "$99.00",
        features: [
            "2 Initial Concepts",
            "2 Revision Rounds",
    ...
    {
        name: "Standard Logo",
        description: "A Professional Logo With Brand-Ready File Formats",
        price: "$199.00",
        features: [
            "4 Initial Concepts",
            "5 Revision Rounds",
    ...
    {
        name: "Premium Logo",
        description: "A Complete Logo Package With Full Creative Ownership",
        price: "$399.00",
        features: [
            "Unlimited Concepts",
            "Unlimited Revisions",
...
function BrushIcon({ className }: { className?: string }) {
    return (
        <svg viewBox="0 0 24 24" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
                d="M14.5 3.5c1.5-1 3.5-1 4.9.4 1.4 1.4 1.4 3.4.4 4.9L11.5 17.1l-5.6 1.4 1.4-5.6L14.5 3.5Z"
                stroke="currentColor"
                strokeWidth="1.5"
                strokeLinejoin="round"
            />
            <path d="M5.9 18.5c-.6 1.2-1.6 2-2.9 2.1 1-1.3 1-2.6.2-3.3" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round" />
        </svg>
    );
}
...
export default function LogoDesignPricingSection() {
    ...
    return (
        <section className="relative w-full bg-[#f5f5f4] px-6 py-20 font-atyp md:px-12 lg:py-28">
            ...
            >
                ...
                >
                    Logo Plans For <span className="font-semibold text-brand">EVERY BUDGET</span>
                </motion.h2>
                ...
                >
                    From A Simple Starter Mark To A Fully-Owned Premium Identity, We Have
                    A Logo Package Built To Fit Your Budget.
                </motion.p>
            </motion.div>

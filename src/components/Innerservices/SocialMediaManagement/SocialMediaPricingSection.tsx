...
const PLANS: Plan[] = [
    {
        name: "Starter Social",
        description: "Consistent Posting To Get Your Social Presence Off The Ground",
        price: "$299.00",
        features: [
            "12 Posts Per Month",
            "1 Platform Managed",
    ...
    {
        name: "Growth Social",
        description: "Full Content And Engagement Management Across Platforms",
        price: "$599.00",
        features: [
            "20 Posts Per Month",
            "2 Platforms Managed",
    ...
    {
        name: "Premium Social",
        description: "Complete Social Strategy With Paid Ad Management Included",
        price: "$1,299.00",
        features: [
            "Daily Posting & Reels",
            "3+ Platforms Managed",
...
function ShareIcon({ className }: { className?: string }) {
    return (
        <svg viewBox="0 0 24 24" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M8 10.8l7.6-3.5M8 13.2l7.6 3.5" stroke="currentColor" strokeWidth="1.3" />
        </svg>
    );
}
    ...
    return (
        <section className="relative w-full bg-[#f5f5f4] px-6 py-20 font-atyp md:px-12 lg:py-28">
            ...
            >
                ...
                >
                    Social Plans For <span className="font-semibold text-brand">EVERY BRAND</span>
                </motion.h2>
                ...
                >
                    From Getting Started To Running Full Paid Campaigns, We Have A Social
                    Media Plan Built To Match Your Growth Stage.
                </motion.p>
            </motion.div>

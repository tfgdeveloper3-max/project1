...
const PLANS: Plan[] = [
    ...
    {
        name: "Growth App",
        description: "A Scalable Application Built For Businesses Ready To Grow",
        price: "$2,999.00",
        features: [
    ...
    {
        name: "Enterprise App",
        description: "Full-Scale Application With Custom Architecture And Support",
        price: "$5,999.00",
        features: [
            "Custom Architecture",
...
function LayersIcon({ className }: { className?: string }) {
    return (
        <svg viewBox="0 0 24 24" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
                d="M12 3.5 3 8.2l9 4.7 9-4.7-9-4.7Z"
                stroke="currentColor"
                strokeWidth="1.5"
                strokeLinejoin="round"
            />
            <path d="M3 12.4l9 4.7 9-4.7M3 16.6l9 4.7 9-4.7" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round" strokeLinecap="round" />
        </svg>
    );
}
...
export default function WebAppPricingSection() {
    ...
    return (
        <section className="relative w-full bg-[#f5f5f4] px-6 py-20 font-atyp md:px-12 lg:py-28">
            ...
            >
                ...
                >
                    Plans Built For <span className="font-semibold text-brand">EVERY SCALE</span>
                </motion.h2>
                ...
                >
                    From A Lean MVP To A Fully-Custom Enterprise Application, We Have A
                    Development Plan That Matches Your Roadmap.
                </motion.p>
            </motion.div>
                        ...
                        >
                            ...
                            <div className="mt-6 flex items-baseline gap-2">
                                ...
                                <span
                                    ...
                                    title="One-time build fee, hosting billed separately"
                                    className={[

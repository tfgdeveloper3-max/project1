...
const FEATURES = [
    {
        ...
        description:
            "Built on a modular foundation that grows with your users, your data, and your feature roadmap.",
    },
    {
        title: "API-First Development",
        description:
            "Clean, documented APIs that connect seamlessly with your existing tools and third-party services.",
    },
];
...
export default function WebAppAboutSection() {
    return (
        <section className="relative w-full bg-[#fdfcf7] px-6 py-20 font-atyp md:px-12 lg:py-28">
            <div className="mx-auto grid max-w-6xl grid-cols-1 items-center gap-16 md:grid-cols-2">
                ...
                >
                    ...
                    >
                        Custom{" "}
                        <span className="font-semibold text-brand">Web & App Solutions</span>{" "}
                        Built To Perform
                    </motion.h2>
                    ...
                    >
                        From Internal Tools To Full-Scale SaaS Products, We Design And Develop
                        Web Applications That Are Fast, Secure, And Built To Handle Real Business
                        Complexity. Every Application We Ship Is Engineered With Clean
                        Architecture, Thorough Testing, And A Focus On Long-Term Maintainability
                ...
                <div className="relative mx-auto aspect-[4/5] w-full max-w-md md:max-w-none">
                    <motion.img
                        src="/images/WebApp1.png"
                        alt="Web application dashboard displayed on monitor and laptop"
                    ...
                    <motion.img
                        ...
                        alt="Developer building a web application interface"
